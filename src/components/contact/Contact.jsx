            ...
            <div className="align-items-center contactDetails d-flex justify-content-around">
              ...
              <div className="social_links">
                <span className="gap-2 justify-content-start">
                  ...
                  <a href="https://www.facebook.com/ripon876" target="_blank">
                    <i class="fa-brands fa-facebook"></i>
                  </a>
                  <a href="https://twitter.com/islam876ripon" target="_blank">
                    <i class="fa-brands fa-twitter"></i>
                  </a>
                  <a href="https://www.instagram.com/ripon_876" target="_blank">
